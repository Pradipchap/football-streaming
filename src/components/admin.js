...
export default function Admin() {
  const docRef = collection(db, "streamlink");
      ...
      >
        <div>
          <TextField
            ...
            label="Enter the first club name"
            multiline
            maxRows={4}
            onChange={(event) => {
          ...
          <TextField
            id="outlined-multiline-flexible"
            label="Enter the second club name"
            multiline
            maxRows={4}
            onChange={(event) => {
        ...
        {/* <div className="container noselect" onClick={adddata}>
          <label htmlFor="checkbox" id="clickHandler" />
          <input type="checkbox" id="checkbox" />
          <button id="button">
            <p id="to-launch">Launch the stream</p>
            <p id="tag">Submitted Successfully</p>
            <div id="platform" />
